...
# Constants
NUM_PLAYERS = 2
OBSERVATION_SPACE_SIZE = 55  # +1 for dummy opp action
ACTION_SPACE_SIZE = 5
...
class BaselineAgent:
    ...
    def get_action(self, obs, mask):
        ...
        obs = torch.cat((obs, torch.tensor([0.0])))  # add dummy opp prediction
...
def pretrain_agent(episodes=10000, save_path="medium_agent.pth"):
    ...
    print(f"✅ Medium opponent model saved to {save_path}")
